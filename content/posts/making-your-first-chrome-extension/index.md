 ...
 * Start with the basics in What are extensions?
 * From there, move to Getting Started.
 * Check out the Sample Extensions.

Learning from others is a good idea too. There are some truly amazing extensions, and by using an extension called Chrome Extension Source Viewer, you can view the source code of any other extension in the store (including itself). It's helpful if you're trying to figure out how someone did something, or just to verify that an extension isn't doing something malicious.
