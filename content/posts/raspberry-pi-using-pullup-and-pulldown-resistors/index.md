...
description = ""
draft = false
image = "https://images.unsplash.com/photo-1532188363366-3a1b2ac4a338?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjExNzczfQ"
...
Instead, I see this, with 10 more screens just like it, in about 5 seconds:
...
All of the examples I've seen elsewhere use 10kΩ, and according to at least one authoritative source you should stick with that (per my comment in the "A Simple Circuit" section above). A higher value resistor allows less current to flow through.
 ...
 * How to use interrupts… Part 1
 * How to use interrupts… Part 2
 * How to use interrupts… Part 3

If you're brand new to Python…

 * Automate the Boring Stuff with Python

And if you just can't get your fill of Pi, check out my list of resources on GitHub:
