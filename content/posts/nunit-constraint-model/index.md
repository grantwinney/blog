...
Those helpful littl![](image-2.webp)ts only show up when you reference the [analyzers for NUnit](https://github.com/nunit/nunit.analyzers), a [separate NuGet package](https://www.nuget.org/packages/NUnit.Analyzers/) from the test library and not one I ever recall adding.
