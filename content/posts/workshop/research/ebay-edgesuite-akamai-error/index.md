...
summary: When eBay went down the other day, everyone started getting edgesuite errors. I was kinda curious what those were.. here's what I found.
...
This seems to be part of their [Web Application Firewall](https://www.akamai.com/glossary/what-is-a-waf) and fwiw they're not the only provider that behaves (to me) unexpectedly. I've had a number of sites toss up weird Cloudflare "are you a human" pages that honestly make it look like the site got hacked. Rather ugly pages that don't fit the site's theme at all. I wonder why they don't polish the experience a bit? Do the companies that use them not realize, or just not care?
